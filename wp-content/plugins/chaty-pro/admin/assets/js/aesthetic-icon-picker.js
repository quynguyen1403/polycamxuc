    ...
    document.querySelector(defaultOpt.onClick).addEventListener('click', function (e) {
        ...
        aestheticDomEle.querySelector('.aim-insert-icon-button').addEventListener('click', function (e) {
            ...
            if (null !== selected) {
                ...
                if(jQuery("#image_agent_data_"+dataSlug).length) {
                    jQuery("#image_agent_data_"+dataSlug).removeClass("img-active").addClass("icon-active");
                    jQuery("#image_agent_data_"+dataSlug+" span.facustom-icon").html("<i class='"+sellectedClass+"'></i>");
                    jQuery("#image_agent_data_"+dataSlug+" .fa-icon").val(sellectedClass);
                    jQuery("#image_agent_data_"+dataSlug+" .image-id").val("");
                } else if(jQuery("#chaty_image_"+dataSlug).length) {
                    jQuery("#chaty_image_" + dataSlug + " .facustom-icon").html("<i class='" + sellectedClass + "'></i>");
                    jQuery("#chaty_image_"+dataSlug).addClass("icon-active").removeClass("img-active");
                    jQuery("#chaty_image_"+dataSlug+ " .fa-icon").val(sellectedClass);
