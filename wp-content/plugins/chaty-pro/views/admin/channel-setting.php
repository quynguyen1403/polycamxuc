    ...
    <div class="channels-selected__item <?php echo esc_attr(($this->is_pro()) ? 'pro' : 'free'); ?> 1 available">
        ...
        <div class="device-agent-settings mt-2">
            ...
            <?php if ($this->is_pro()) { ?>
                ...
                <?php } else { ?>
                    <div class="channels__agent-box transparent hidden">
                        <a href="#" class="agent-button-action">
        ...
        <div class="chaty-advance-settings <?php echo esc_attr($class_name); ?>" style="<?php echo (empty($close_class) && $social['slug'] == 'Contact_Us') ? "display:block" : ""; ?>">
            <div class="chaty-channel-setting space-y-4">
                ...
                <div class="chaty-setting-col sm:flex sm:items-center sm:space-x-3">
                    <label class="font-primary text-base text-cht-gray-150 sm:w-44">On Hover Text</label>
                    <div>
                        <!-- input for custom title -->
                ...
                <div class="Whatsapp-settings advanced-settings">
                    <div class="chaty-setting-col sm:flex items-center space-y-2 sm:space-y-0 sm:space-x-3">
                        <label class="font-primary text-base text-cht-gray-150 sm:w-44">Whatsapp Web</label>
                        <div>
                    ...
                    <div class="Contact_Us-settings advanced-settings">
                        ...
                        <div class="form-field-setting-col no-margin">
                            ...
                            <div class="chaty-setting-col mt-3">
                                <label for="save_leads_to_email_<?php echo esc_attr($social['slug']); ?>" class="email-setting full-width chaty-switch text-base text-cht-gray-150 flex items-center">
                            ...
                            <div class="email-settings <?php echo ($field_value == "yes") ? "active" : "" ?>">
                                <div class="chaty-setting-col">
                                    ...
                                    <div>
                                        ...
                                        <input class="w-full" id="email_for_<?php echo esc_attr($social['slug']); ?>" type="text" name="cht_social_<?php echo esc_attr($social['slug']); ?>[email_address]" value="<?php echo esc_attr($field_value); ?>" >
                                    </div>
                                </div>
                                <div class="chaty-setting-col">
                                    ...
                                    <div>
                                        ...
                                        <input class="w-full" id="sender_name_for_<?php echo esc_attr($social['slug']); ?>" type="text" name="cht_social_<?php echo esc_attr($social['slug']); ?>[sender_name]" value="<?php echo esc_attr($field_value); ?>" >
                                    </div>
                                </div>
                                <div class="chaty-setting-col">
                                    ...
                                    <div>
                                        ...
                                        <input class="w-full" id=email_subject_for_<?php echo esc_attr($social['slug']); ?>" type="text" name="cht_social_<?php echo esc_attr($social['slug']); ?>[email_subject]" value="<?php echo esc_attr($field_value); ?>" >
                ...
                <div class="border border-solid border-cht-primary rounded-lg" style="background-color: #F7F2FD">
                    ...
                    <main class="chaty-channel-setting hidden chaty-channel-main-settings space-y-4 px-5 md:px-24 border-t border-solid border-cht-gray-150/10 py-5">
                        ...
                        <div class="grid grid-cols-2 gap-5">
                            <div>
                                <label class="font-priamry text-cht-gray-150/70 text-base mb-2 block"><?php esc_html_e("On Hover Text", "chaty"); ?></label>
