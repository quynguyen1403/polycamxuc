...
class Gostudy_Breadcrumb_Trail {
	...
	protected function set_labels() {
		...
		$defaults = array(
			...
			'home'                => esc_html__( 'Trang chủ',                                  'gostudy' ),
			'error_404'           => esc_html__( '404 Không tìm thấy',                         'gostudy' ),
			'archives'            => esc_html__( 'Lưu trữ',                              'gostudy' ),
			// Translators: %s is the search query.
			'search'              => esc_html__( 'Kết quả tìm kiếm chó: %s',                'gostudy' ),
			// Translators: %s is the page number.
			'paged'               => esc_html__( 'Trang %s',                               'gostudy' ),
			// Translators: %s is the page number.
			'paged_comments'      => esc_html__( 'Bình luận trang %s',                       'gostudy' ),
			// Translators: Minute archive title. %s is the minute time format.
			'archive_minute'      => esc_html__( 'Phút %s',                             'gostudy' ),
			// Translators: Weekly archive title. %s is the week date format.
			'archive_week'        => esc_html__( 'Tuần %s',                               'gostudy' ),
