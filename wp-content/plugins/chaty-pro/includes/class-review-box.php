...
class Chaty_pro_review_box
{
    ...
    public function __construct()
    {
        ...
        add_action("wp_ajax_".$this->plugin_slug."_review_box", [$this, "form_review_box"]);
        ...
        if (current_user_can('manage_options')) {
            ...
            <div
                ...
                <div class="review-box-default" id="default-review-box-<?php echo esc_attr($this->plugin_slug) ?>">
                    ...
                    <ul>
                        <li><a class="<?php echo esc_attr($this->plugin_slug) ?>-premio-review-box-hide-btn" href="https://wordpress.org/support/plugin/chaty/reviews/?filter=5" target="_blank"><?php esc_html_e("I'd love to help :) ", 'chaty')?></a></li>
                        <li><a class="<?php echo esc_attr($this->plugin_slug) ?>-premio-review-box-future-btn" href="javascript:;"><?php esc_html_e("Not this time ", 'chaty')?></a></li>
                        <li><a class="<?php echo esc_attr($this->plugin_slug) ?>-premio-review-box-hide-btn" href="javascript:;"><?php esc_html_e("I've already rated you ", 'chaty')?></a></li>
                    </ul>
                </div>
