...
class Master_Addons_Assets
{
    ...
    public function jltma_register_frontend_styles()
    {
        ...
        if (ma_el_fs()->can_use_premium_code__premium_only()) {
            wp_register_style('jltma-pro', JLTMA_URL . '/premium/assets/css/master-addons-pro.css');
            // wp_register_script('jltma-pro', JLTMA_URL . '/premium/assets/js/master-addons-pro.js', ['jquery', 'master-addons-scripts'], JLTMA_VER, true);
        }
    }
    ...
    public function jltma_register_frontend_scripts()
    {
        ...
        wp_register_script('swiper', 'https://cdnjs.cloudflare.com/ajax/libs/Swiper/5.3.6/js/swiper.js', ['jquery'], JLTMA_VER, true);
        wp_register_script('ma-animated-headlines', JLTMA_URL . '/assets/js/animated-main.js', ['jquery'], JLTMA_VER, true);

        wp_register_script('master-addons-progressbar', JLTMA_URL . '/assets/js/loading-bar.js', ['jquery'], JLTMA_VER, true);

        wp_register_script('jquery-stats', JLTMA_URL . '/assets/js/jquery.stats.js', ['jquery'], JLTMA_VER, true);

        wp_register_script('master-addons-waypoints', JLTMA_URL . '/assets/vendor/jquery.waypoints.min.js', ['jquery'], JLTMA_VER, true);

        wp_register_script('jltma-owl-carousel', JLTMA_URL . '/assets/vendor/owlcarousel/owl.carousel.min.js', ['jquery'], JLTMA_VER, true);

        wp_register_script('gridder', JLTMA_URL . '/assets/vendor/gridder/js/jquery.gridder.min.js', ['jquery'], JLTMA_VER, true);

        wp_register_script('isotope', JLTMA_URL . '/assets/js/isotope.js', ['jquery'], JLTMA_VER, true);

        wp_register_script('ma-news-ticker', JLTMA_URL . '/assets/vendor/newsticker/js/newsticker.js', ['jquery'], JLTMA_VER, true);

        wp_register_script('jquery-rss', JLTMA_URL . '/assets/vendor/newsticker/js/jquery.rss.min.js', ['jquery'], JLTMA_VER, true);

        wp_register_script('ma-counter-up', JLTMA_URL . '/assets/js/counterup.min.js', ['jquery'], JLTMA_VER, true);

        wp_register_script('ma-countdown', JLTMA_URL . '/assets/vendor/countdown/jquery.countdown.js', ['jquery'], JLTMA_VER, true);

        wp_register_script('jltma-table-of-content', JLTMA_URL . '/assets/vendor/jltma-table-of-content/jltma-table-of-content.js', ['jquery'], JLTMA_VER, true);

        wp_register_script('fancybox', JLTMA_URL . '/assets/vendor/fancybox/jquery.fancybox.min.js', ['jquery'], JLTMA_VER, true);

        if (ma_el_fs()->can_use_premium_code()) {
            // GSAP TweenMax
            wp_register_script('gsap-js', '//cdnjs.cloudflare.com/ajax/libs/gsap/' . $this->gsap_version . '/TweenMax.min.js', array(), null, true);
        }
        wp_register_script('jltma-timeline', JLTMA_URL . '/assets/js/timeline.js', ['jquery'], JLTMA_VER, true);

        wp_register_script('jltma-tilt', JLTMA_URL . '/assets/vendor/tilt/tilt.jquery.min.js', ['jquery'], JLTMA_VER, true);

        if (ma_el_fs()->can_use_premium_code()) {
            // Navmenu & Offcanvas Menu
            wp_register_script('jltma-offcanvas-menu', JLTMA_URL . '/assets/js/addons/offcanvas-menu.js', ['jquery'], JLTMA_VER, true);
            wp_register_script('jltma-nav-menu', JLTMA_URL . '/assets/js/addons/jltma-nav-menu.js', ['jquery', 'elementor-frontend-modules'], JLTMA_VER, true);
        }
        ...
        // Image Comparison
        wp_register_script('jquery-event-move', JLTMA_URL . '/assets/vendor/image-comparison/js/jquery.event.move.js', ['jquery'], JLTMA_VER, true);
        wp_register_script('twentytwenty', JLTMA_URL . '/assets/vendor/image-comparison/js/jquery.twentytwenty.js', ['jquery'], JLTMA_VER, true);

        // Toggle Content
        wp_register_script('jltma-toggle-content', JLTMA_URL . '/assets/vendor/toggle-content/toggle-content.js', ['jquery'], JLTMA_VER, true);
        ...
        if (ma_el_fs()->can_use_premium_code__premium_only()) {
            wp_register_script('jltma-prism', JLTMA_URL . '/premium/assets/vendor/prism.min.js', array('jquery', 'master-addons-scripts'), JLTMA_VER, true);

            // PDF Viewer
            wp_register_script('jltma-pdf-viewer', JLTMA_URL . '/assets/js/addons/jltma-pdf-viewer.js', ['jquery'], JLTMA_VER, true);

            // Pie Chart
            wp_register_script('jltma-piechart', JLTMA_URL . '/premium/assets/js/addons/jltma-piechart.js', array('jquery'), JLTMA_VER, true);
        }
    ...
    public function jltma_enqueue_scripts()
    {
        ...
        //Reveal
        wp_register_script('ma-el-reveal-lib', JLTMA_URL . '/assets/vendor/reveal/revealFx.js', ['jquery'], JLTMA_VER, true);
        wp_register_script('ma-el-anime-lib', JLTMA_URL . '/assets/vendor/anime/anime.min.js', ['jquery'], JLTMA_VER, true);

        //Rellax
        wp_register_script('ma-el-rellaxjs-lib', JLTMA_URL . '/assets/vendor/rellax/rellax.min.js', ['jquery'], JLTMA_VER, true);
        ...
        // Enqueue Scripts
        wp_enqueue_script('master-addons-plugins', JLTMA_URL . '/assets/js/plugins.js', ['jquery'], JLTMA_VER, true);
        wp_enqueue_script('master-addons-scripts', JLTMA_URL . '/assets/js/master-addons-scripts.js', ['jquery'], JLTMA_VER, true);


        if (ma_el_fs()->can_use_premium_code__premium_only()) {

            // Master Addons Pro Style
            wp_enqueue_style('jltma-pro');

            // Master Addons Pro Script
            wp_enqueue_script('jltma-pro');
        }
