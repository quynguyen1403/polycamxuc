...
function doi_lich_hoc()
{
    ...
    echo '<form class="form-search-query" action="" method="get" style="margin:auto;max-width:300px">
          ...
          $q = $_GET['q'];
    echo '<br>';
    echo '<p class="count_ca">Ca học đang tìm đổi: <span class="count_number">'.$count_ca.'</span></p>';
    echo '<table>';
    echo '<tr>
            <th style="width:25%; vertical-align:middle" rowspan="2" class="title-table">Môn Học <br> (ghi theo đúng trên AP)</th>
            <th class="hientai title-table" colspan="3">Lịch học hiện tại</th>
            <th class="mongmuon title-table" colspan="3">Lịch học mong muốn</th>
            <th style="width:10%; vertical-align:middle" rowspan="2" class="title-table">Thông tin liên hệ <br> (SĐT/Zalo)</th>
          </tr>';
    echo '<tr>
