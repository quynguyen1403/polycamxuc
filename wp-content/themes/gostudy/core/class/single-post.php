            ...
            if (
                ...
                if ($this->show_meta_comments) {
                    ...
                    echo '<span class="comments_post">',
                        '<a href="', esc_url(get_comments_link()), '" title="', esc_attr__('Lượt bình luận', 'gostudy'), '">',
                            esc_html($comments_num),
                            ' ',
                            esc_html(_n('Bình luận', 'Bình luận', $comments_num, 'gostudy')),
                        '</a>',
                    '</span>';
                }
        ...
        public function render_post_meta_2($args = false)
        {
            ...
            if (
                ...
                if ($this->show_meta_comments) {
                    $comments_num = get_comments_number($this->post_id);
                    echo '<span class="comments_post">',
                        '<a href="', esc_url(get_comments_link()), '" title="', esc_attr__('Lượt bình luân', 'gostudy'), '">',
                            esc_html($comments_num),
                            ' ',
                            esc_html(_n('Bình luận', 'Bình luận', $comments_num, 'gostudy')),
                        '</a>',
