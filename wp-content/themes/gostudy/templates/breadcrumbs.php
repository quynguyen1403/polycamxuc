...
if (!class_exists('Gostudy_Breadcrumbs')) {
    ...
    class Gostudy_Breadcrumbs
    {
        ...
        {
            $this->text_home     = esc_html__('Trang chủ', 'gostudy'); // text for the `Home` link
            $this->text_category = esc_html__('Lưu trữ theo danh mục "%s"', 'gostudy'); // text for a category page
            $this->text_search   = esc_html__('Tìm kiếm kết quả cho "%s"', 'gostudy'); // text for a search results page
            $this->text_tag      = esc_html__('Bài đăng đánh dấu "%s"', 'gostudy'); // text for a tag page
            $this->text_author   = esc_html__('Bài đăng bởi %s', 'gostudy'); // text for an author page
            $this->text_404      = esc_html__('Lỗi 404', 'gostudy'); // text for the 404 page
            $this->text_page     = esc_html__('Trang %s', 'gostudy'); // text 'Page N'
            $this->text_cpage    = esc_html__('Bình luận trang %s', 'gostudy'); // text `Comment Page N`
        }
