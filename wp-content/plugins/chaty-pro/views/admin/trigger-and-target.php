                            ...
                            <div class="chaty-date-time-option group-control-wrap mb-2 p-5 relative" data-index="<?php echo esc_attr($count) ?>">
                                <div class="date-time-content grid grid-cols-2 gap-4 <?php echo esc_attr($is_pro ? "is-pro" : "not-pro") ?>">
                                    <div class="day-select col-span-2">
                                        ...
                                        <select class="cht-required w-full" name="cht_date_and_time_settings[<?php echo esc_attr($count) ?>][days]" id="url_shown_on_<?php echo esc_attr($count) ?>_option">
            ...
            <label class="form-horizontal__item-label font-primary text-cht-gray-150 text-base block mb-3">
                ...
                <span class="header-tooltip">
                    <span class="header-tooltip-text text-center">
                        <?php esc_html_e("Show or don't show the widget on specific pages. You can use rules like contains, exact match, starts with, and ends with", 'chaty') ?>
                    </span>
                    <span class="ml-1">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                            <path d="M8.00004 14.6654C11.6819 14.6654 14.6667 11.6806 14.6667 7.9987C14.6667 4.3168 11.6819 1.33203 8.00004 1.33203C4.31814 1.33203 1.33337 4.3168 1.33337 7.9987C1.33337 11.6806 4.31814 14.6654 8.00004 14.6654Z" stroke="#72777c" stroke-width="1.33" stroke-linecap="round" stroke-linejoin="round"></path>
                                ...
                                <div class="url-content <?php echo !$is_pro ? 'pointer-events-none': '' ?> <?php echo esc_attr(($option['option'] == "home") ? "v-hide" : "") ?>">
                                    ...
                                    <div class="grid grid-cols-2 gap-4">
                                        <div class="url-select">
                                            <select class="cht-required w-full" name="cht_page_settings[<?php echo esc_attr($count)  ?>][shown_on]" id="url_shown_on_<?php echo esc_attr($count)  ?>_option">
                                        ...
                                        <div class="url-option">
                                            <select class="url-options cht-required w-full" name="cht_page_settings[<?php echo esc_attr($count)  ?>][option]" id="url_rules_<?php echo esc_attr($count)  ?>_option">
                                    ...
                                    <div class="sm:flex items-center mt-2">
                                        <div class="url-box">
                                            <span class='chaty-url'><?php echo esc_attr(site_url("/")); ?></span>
                                        </div>
                                        <div class="url-values">
                                            <?php
                                            $option['value'] = replaceDomain($option['value']) ?>
                                            <input type="text" class="w-full <?php echo esc_attr(($option['option'] == "home") ? "" : "cht-required") ?> url-value" value="<?php echo esc_attr($option['value']) ?>" name="cht_page_settings[<?php echo esc_attr($count)  ?>][value]" id="url_rules_<?php echo esc_attr($count)  ?>_value" />
                                        </div>
                                    </div>
...
<div class="chaty-date-and-time-options-html" style="display: none">
    <div class="chaty-date-time-option group-control-wrap mb-2 p-5 relative" data-index="__count__">
        <div class="date-time-content grid grid-cols-2 gap-4 <?php echo esc_attr($is_pro ? "is-pro" : "not-pro") ?>">
            <div class="day-select col-span-2">
                <label class="block font-primary text-cht-gray-150 text-base my-2"><?php esc_html_e('Select day', 'chaty') ?></label>
                <select class="cht-required w-full" name="cht_date_and_time_settings[__count__][days]" id="url_shown_on___count___option">
                    <?php foreach ($days as $key => $value) { ?>
...
<div class="chaty-page-options-html" style="display: none">
    <div class="chaty-page-option group-control-wrap mb-2 py-5 pl-5 pr-7 relative  <?php echo esc_attr($is_pro ? "is-pro" : "not-pro") ?>">
        <div class="url-content">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div class="url-select">
                    <select class="cht-required w-full" name="cht_page_settings[__count__][shown_on]" id="url_shown_on___count___option">
                        <option value="show_on">Show on</option>
                        <option value="not_show_on">Don't show on</option>
                    </select>
                </div>
                <div class="url-option">
                    <select class="url-options cht-required w-full" name="cht_page_settings[__count__][option]" id="url_rules___count___option">
            ...
            <div class="sm:flex items-center mt-2">
                ...
                <div class="url-values">
                    <input type="text" class="cht-required url-value w-full" value="" name="cht_page_settings[__count__][value]" id="url_rules___count___value" />
                </div>
            </div>
