          ...
          <div class="row">
            <div class="rt_col-12 rt_col-md-12">
              <div class="main_404-wrapper">
                ...
                <h2 class="banner_404_title"><span style="font-family:'Roboto', sans-serif; "><?php esc_html_e('Không tìm thấy trang này!', 'gostudy'); ?></span></h2>
                <p class="banner_404_text">
                  <?php esc_html_e('Trang bạn đang tìm có thể đã bị gỡ, đổi tên hoặc không tồn tại.', 'gostudy'); ?>
                </p>
